                        ...
                        <div className="d-flex gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-dark">
                              Certification in Full Stack Web Development (MERN)
                            </p>
                          </div>
                        </div>
                      </li>
            ...
            <div className="col-lg-6 pt-3">
              <div className="bg-3 rounded-3 border border-1 p-md-6 p-3 position-relative h-100 overflow-hidden">
                <div className="d-flex align-items-center">
                  ...
                  <h2 className="mb-0 ms-2">Self-Learning</h2>
                </div>
                <div className="d-flex flex-column h-100 position-relative mt-5">
                  <ul className="ps-3">
                    <li className="position-relative z-1 mb-3">
                      <div className="d-flex gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-dark">
                            Integrated Prisma ORM and PostgreSQL into full-stack
                            projects.
                          </p>
                        </div>
                      </div>
                    ...
                    <li className="position-relative z-1 mb-3">
                      <div className="d-flex gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-dark">
                            Developed full-stack blogs and APIs using GraphQL
                            and headless CMS.
                          </p>
                        </div>
                      </div>
                    ...
                    <li className="position-relative z-1 mb-3">
                      <div className="d-flex gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-dark">
                            Implemented JSON-LD, sitemap generation, and static
                            page SEO strategies.
                          </p>
                        </div>
                      </div>
