                  ...
                  <div className="p-lg-0 p-md-8 p-3">
                    <div className="text-secondary-2 d-flex align-items-center">
                      ...
                      <div className="text-dark">
                        <div className="typewriter">
                          <h1 className="fs-6 fw-medium">Hey, I’m Ashik</h1>
                        </div>
                      </div>
                      &lt;/span&gt;
                    </div>
                    ...
                    <p className="mb-6 text-secondary-2">
                      ...
                      <span className="text-dark">
                        With hands-on experience in modern technologies such as
                      </span>{' '}
                      <span className="text-secondary-2">React.js</span>,{' '}
                      <span className="text-secondary-2">Next.js</span>,{' '}
                      <span className="text-secondary-2">Tailwind CSS</span>,{' '}
                      <span className="text-secondary-2">TypeScript</span>,{' '}
                      <span className="text-secondary-2">Node.JS</span>, and{' '}
                      <span className="text-secondary-2">Express.JS</span>
                      <span className="text-dark">
                        , I build high-performance, SEO-optimized, and scalable
                        web applications that drive user engagement and deliver
                        business value.
                      </span>
                      &lt;/p&gt;
                    </p>
